...
class TestRoutingTable:
    ...
    def test_basics(self):
        ...
        eq_(self.rt.get_closest_rnodes(tc.SERVER_ID, max_rnodes=1),
            [tc.SERVER_NODE])
        eq_(self.rt.get_closest_rnodes(tc.SERVER_ID),
            [tc.SERVER_NODE, new_node, tc.CLIENT_NODE])
        eq_(self.rt.get_closest_rnodes(tc.SERVER_ID, exclude_myself=False),
            [tc.SERVER_NODE, new_node, tc.CLIENT_NODE])
        eq_(self.rt.get_closest_rnodes(tc.SERVER_ID, exclude_myself=True),
            [tc.SERVER_NODE, new_node])
        ...
        eq_(self.rt.get_closest_rnodes(tc.SERVER_ID, exclude_myself=True), [tc.SERVER_NODE])
    ...
    def test_get_closest_rnodes(self):
        ...
        eq_(self.rt.get_closest_rnodes(tc.CLIENT_ID,
                                       exclude_myself=True),
            nodes)
        ...
        closest_nodes = self.rt.get_closest_rnodes(nodes[-1].id,
                                                   exclude_myself=True)
    ...
    def test_complete_coverage(self):
        ...
        eq_(self.rt.get_closest_rnodes(tc.SERVER_ID), [tc.CLIENT_NODE])
        log_distance = self.my_node.log_distance(tc.SERVER_NODE)
