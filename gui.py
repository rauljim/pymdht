...
#        obj=lucgee.Lookupconverge_ext(None,"Lookup@KAD Converge Visualization",self.QueResErrList,(1440,900)).Show()
    ...
    def load_controls(self):
        ...
        self.toolbar.AddLabelTool(1, "Run", wx.Bitmap('gui/images/run.png'))
        self.Bind(wx.EVT_TOOL, self.run, id=1)
        self.toolbar.AddSeparator()
        self.toolbar.AddLabelTool(2, "Save", wx.Bitmap('gui/images/exit.png'))
        self.Bind(wx.EVT_TOOL, self.save_infile, id=2)
        self.toolbar.AddLabelTool(3, "Graphical Display", wx.Bitmap('gui/images/Graph.png'))
        self.toolbar.AddSeparator()
        self.Bind(wx.EVT_TOOL, self.on_graphical_display, id=3)
        self.toolbar.AddSeparator()
        self.toolbar.AddLabelTool(4, "Exit", wx.Bitmap('gui/images/exit.png'))
